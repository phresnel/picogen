...
#ifndef RAYDIRVIS_H__INCLUDED
#define RAYDIRVIS_H__INCLUDED

namespace picogen {
    namespace graphics {
        namespace film {

            class RayDirVis : public abstract::IFilm {
                private:
                ...
                public:
                    RayDirVis (unsigned int width, unsigned int height);
                    ~RayDirVis ();
