    ...
    namespace graphics {
        namespace integrators {
            namespace screen {
                ...
                */
                void XYIterator::setNumPixelsPerContinue (unsigned int num) {
                ...
                bool XYIterator::renderMore() {
                    ...
                    if (!m_done) {
                        ...
                        while (num++ < m_numPixelsPerRun) {
                            ...
                            if (m_surfaceIntegrator->integrate (sample)) {
