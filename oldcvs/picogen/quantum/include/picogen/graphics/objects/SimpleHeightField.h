...
class SimpleHeightField : public abstract::IIntersectable
{
	private:
		...
		material::abstract::IBRDF *m_pBRDF;
		material::abstract::IShader *m_pShader;
	...
	public:
		...
		void SetBRDF( material::abstract::IBRDF* const brdf );
		void SetShader( material::abstract::IShader* const shader );
		void Init( unsigned int size, const misc::functions::abstract::uv_to_scalar *heightFunc );
