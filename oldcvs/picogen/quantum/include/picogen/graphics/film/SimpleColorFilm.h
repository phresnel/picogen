...
#ifndef SIMPLECOLORFILM_H__INCLUDED
#define SIMPLECOLORFILM_H__INCLUDED

namespace picogen {
    namespace graphics {
        namespace film {

            class SimpleColorFilm : public abstract::IFilm {
                private:
                ...
                public:
                    SimpleColorFilm(unsigned int width, unsigned int height);
                    ~SimpleColorFilm();
...
#endif // SIMPLECOLORFILM_H__INCLUDED
