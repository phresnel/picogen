...
class Transformation{
	...
	public:
		...
		inline Transformation setToPerspectiveFovLH( real fov, real aspectRatio, real zn, real zf )
		{
			...
			matrix._11=w;  matrix._12=0;  matrix._13=0;              matrix._14=0;
			matrix._21=0;  matrix._22=h;  matrix._23=0;              matrix._24=0;
			matrix._31=0;  matrix._32=0;  matrix._33=zf/(zf-zn);     matrix._34=1;
			matrix._41=0;  matrix._42=0;  matrix._43=-zn*zf/(zf-zn); matrix._44=0;
			return *this;
		}
		...
		inline Transformation setToLookAtLH( const Vector3d &eye, const Vector3d &at, const Vector3d &up )
		{
			...
			matrix._11 =  X[0];   matrix._12 =  Y[0];   matrix._13 =  Z[0];   matrix._14 =    0;
			matrix._21 =  X[1];   matrix._22 =  Y[1];   matrix._23 =  Z[1];   matrix._24 =    0;
			matrix._31 =  X[2];   matrix._32 =  Y[2];   matrix._33 =  Z[2];   matrix._34 =    0;
