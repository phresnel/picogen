...
namespace geometrics{
	...
	class BoundingBox{
		...
		public:
			...
			const Vector3d median() const{ return (bbmin+bbmax)*0.5; }
			const Vector3d min() const{ return bbmin; }
			const Vector3d max() const{ return bbmax; }
			Vector3d &min() { return bbmin; }
			Vector3d &max() { return bbmax; }
