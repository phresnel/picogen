...
namespace functions{
	...
	namespace vector_to_scalar{
		...
		class Sine : public abstract::vector_to_scalar, public abstract::scalar_to_scalar, public abstract::uv_to_scalar{
			...
			public:
				...
				virtual real f( real x, real y, real z ) const {
					...
					switch( m_mode ){
						case ridged: A = 1.0 - fabs(A); break;
						case lava:   A = fabs(A);       break;
		...
		class PerlinNoise_Elias : public abstract::vector_to_scalar, public abstract::scalar_to_scalar, public abstract::uv_to_scalar{
			...
			public:
				...
				void setMode( mode m ){ EvalMode = m; }
				void setBaseFrequency( float f ) { BaseFrequency = f; }

				/*void  enableRidge( bool t ) { EnableRidge = t; }
				void  enableLava( bool t )  { EnableLava = t; }*/
				void  setDomainScale( float f )   { DomainScale = f; }
				float getDomainScale() const      { return DomainScale; }
				void  setRangeScale( float f )    { RangeScale = f; }
				float getRangeScale() const       { return RangeScale; }
				...
				int   getOctaves() const             { return Iterations+1;}

				void  setEvalScale( float f ) { EvalScale = f; }
				float getEvalScale() const    { return EvalScale; }
		...
		class Sum : public abstract::vector_to_scalar {
			...
			public:
				...
				void setA( abstract::vector_to_scalar *a ) { this->a = a; }
				void setB( abstract::vector_to_scalar *a ) { this->b = b; }
				virtual misc::prim::real f( misc::prim::real x, misc::prim::real y, misc::prim::real z ) const{
		...
		class Power : public abstract::vector_to_scalar {
			...
			public:
				Power() : a(NULL), p(1.0) {}
				Power( abstract::vector_to_scalar *_a, misc::prim::real _p ) : a(_a), p(_p) {}
				void setA( abstract::vector_to_scalar *a ) { this->a = a; }
				void setB( misc::prim::real p ) { this->p = p; }
				virtual misc::prim::real f( misc::prim::real x, misc::prim::real y, misc::prim::real z ) const{
		...
		class InputDistorter : public abstract::vector_to_scalar {
			...
			public:
				...
				void setDistortion( abstract::scalar_to_scalar *dist ){ Distortion = dist; }
				void setFunction( abstract::vector_to_scalar *func ){ Function = func; }
	...
	namespace uv_to_scalar{
		...
		class Negate : public abstract::uv_to_scalar {
			...
			public:
				...
				void setA( abstract::uv_to_scalar *a ) { this->a = a; }
				virtual misc::prim::real f( misc::prim::real x, misc::prim::real y ) const{
		...
		class Sum : public abstract::uv_to_scalar {
			...
			public:
				...
				void setA( abstract::uv_to_scalar *a ) { this->a = a; }
				void setB( abstract::uv_to_scalar *a ) { this->b = b; }
				virtual misc::prim::real f( misc::prim::real x, misc::prim::real y ) const{
		...
		class Power : public abstract::uv_to_scalar {
			...
			public:
				Power() : a(NULL), p(1.0) {}
				Power( abstract::uv_to_scalar *_a, misc::prim::real _p ) : a(_a), p(_p) {}
				void setA( abstract::uv_to_scalar *a ) { this->a = a; }
				void setB( misc::prim::real p ) { this->p = p; }
				virtual misc::prim::real f( misc::prim::real x, misc::prim::real y ) const{
	...
	namespace scalar_to_scalar{
		// TODO: remove aliases and implement dedicated 1d-to-1d-functions
		typedef vector_to_scalar::PerlinNoise_Elias PerlinNoise_Elias;
		typedef vector_to_scalar::PerlinNoise       PerlinNoise;
		typedef vector_to_scalar::Sine              Sine;
	};
