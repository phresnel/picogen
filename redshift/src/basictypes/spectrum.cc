...
const real_t CIE_X[CIE_SAMPLES] = {
...
const real_t CIE_Y[CIE_SAMPLES] = {
...
const real_t CIE_Z[CIE_SAMPLES] = {
...
const real_t CIE_lambda[CIE_SAMPLES] = {
...
const real_t RGBRefl2SpectWhite[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectCyan[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectMagenta[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectYellow[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectRed[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectGreen[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBRefl2SpectBlue[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectWhite[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectCyan[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectMagenta[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectYellow[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectRed[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectGreen[RGB_TO_SPECTRUM_SAMPLES] = {
...
const real_t RGBIllum2SpectBlue[RGB_TO_SPECTRUM_SAMPLES] = {
