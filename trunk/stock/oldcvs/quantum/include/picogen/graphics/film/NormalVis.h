...
#ifndef NORMALVIS_H__INCLUDED
#define NORMALVIS_H__INCLUDED

namespace picogen {
    namespace graphics {
        namespace film {

            class NormalVis : public abstract::IFilm {
                private:
                ...
                public:
                    NormalVis (unsigned int width, unsigned int height);
                    ~NormalVis();
