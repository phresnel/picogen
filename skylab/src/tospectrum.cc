...
namespace {
        ...
        Spectrum riS0Spectrum, riS1Spectrum, riS2Spectrum;
        }
...
Spectrum PreethamShirleySmits::ChromaticityToSpectrum(real_t x, real_t y) const
{
    ...
    real_t M2 = ( 0.03   -31.4424*x + 30.0717*y)/(0.0241 + 0.2562*x - 0.7341*y);
