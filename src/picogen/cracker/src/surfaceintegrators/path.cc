...
namespace detail {
                              ...
                              unsigned int rec)
        {
                ...
                const Color& sun_rad = scene.sunRadiance(POI, out_dir_world);
                                /*scene.radiance(POI,
                                                  out_dir_world);*/
                ...
                const Color& c = sun_rad * brdf.color() * (dot/pdf);
                              ...
                              const unsigned int rec)
        {
                ...
                for (unsigned int depth=0; depth!=rec; ++depth) {
                        ...
                        throughput *= renderer.transmittance (ray, random);
...
Color PathIntegrator::operator() (Ray const &ray,
                                  ...
                                  Random &random) const
{
        return detail::path_iterative (ray, i, scene, renderer, random, 2);
}
